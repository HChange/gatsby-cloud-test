...
type MdxFrontmatterFieldSelector = {
  ...
  readonly name: InputMaybe<FieldSelectorEnum>;
  readonly router: InputMaybe<FieldSelectorEnum>;
...
type MdxFrontmatterFilterInput = {
  ...
  readonly name: InputMaybe<StringQueryOperatorInput>;
  readonly router: InputMaybe<StringQueryOperatorInput>;
...
type MdxFrontmatterSortInput = {
  ...
  readonly name: InputMaybe<SortOrderEnum>;
  readonly router: InputMaybe<SortOrderEnum>;
...
type AllQueryVariables = Exact<{ [key: string]: never; }>;


type AllQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly excerpt: string | null, readonly frontmatter: { readonly name: string | null, readonly time: string | null, readonly router: string | null } | null }> } };

type FileInfoQueryVariables = Exact<{
  id?: InputMaybe<Scalars['String']>;
}>;


type FileInfoQuery = { readonly file: { readonly root: string, readonly relativePath: string, readonly relativeDirectory: string, readonly rdev: number, readonly publicURL: string | null, readonly prettySize: string, readonly nlink: number, readonly name: string, readonly mtimeMs: number, readonly mtime: string, readonly modifiedTime: string, readonly mode: number, readonly size: number, readonly childMdx: { readonly id: string } | null } | null };
...
type IndexPageQuery = { readonly site: { readonly siteMetadata: { readonly description: string | null, readonly siteUrl: string | null, readonly title: string | null } | null } | null };
...
type PostQuery = { readonly mdx: { readonly body: string | null, readonly excerpt: string | null, readonly id: string, readonly frontmatter: { readonly creator: string | null, readonly date: string | null, readonly hero_image_alt: string | null, readonly name: string | null, readonly router: string | null, readonly slug: string | null, readonly time: string | null } | null } | null };

type StatusQueryVariables = Exact<{
  frontmatter__router?: InputMaybe<Scalars['String']>;
}>;


type StatusQuery = { readonly mdx: { readonly id: string, readonly frontmatter: { readonly name: string | null, readonly creator: string | null, readonly time: string | null, readonly slug: string | null, readonly router: string | null, readonly date: string | null, readonly hero_image_alt: string | null, readonly hero_image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };

type UseSiteMetadataQueryVariables = Exact<{ [key: string]: never; }>;


type UseSiteMetadataQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly image: string | null, readonly siteUrl: string | null } | null } | null };

type AllMdxQueryQueryVariables = Exact<{ [key: string]: never; }>;


type AllMdxQueryQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly router: string | null } | null, readonly internal: { readonly contentFilePath: string | null } }> } };
